...
export const AuthenticationComponent = () => {
  ...
  const isValidForm=()=>{
    ...
    // validate email
    if (!emailRef.current.value.toLowerCase().match(
    ...
    if (authenticationAction == "signup") {
      return (
        <>
            ...
            />
            <div className="authentication-form-error-message">{errors.confirmPassword}</div>
        </>
      );
    }
    return (<>
      ...
      <div className="authentication-modal-window-container">
        ...
        >
          ...
          <input
            ...
            required
          />
          <div className="authentication-form-error-message">{errors.email}</div>
          <input
            className="authentication-text-input"
            ...
            required
          />
          <div className="authentication-form-error-message">{errors.password}</div>
