...
export const ContactsComponent = () => {
  return (
    <section className="contacts-component-body">
      ...
      <p className="contacts-components-subheader">
        ...
        <div className="contacts-container">
          <div className="contacts-single-item-container">
            <img
              ...
              alt="icon"
            />
            <p className="contacts-single-item-text">
              Opletalova 23, Prague, Czech Republic
            </p>
          </div>
          <div className="contacts-single-item-container">
            <img src={callIcon} alt="icon" className="contacts-small-icon" />
            <p className="contacts-single-item-text">+420 722-222-333</p>
          </div>
          <div className="contacts-single-item-container">
            <img className="contacts-small-icon" src={emailIcon} alt="icon" />
            <p className="contacts-single-item-text">jobagency@hotline.com</p>
          </div>
          <div className="contacts-single-item-container">
            <img className="contacts-small-icon" src={timeIcon} alt="icon" />
          ...
          <p className="contacts-register-text">
            Firma je zapsána v obchodním rejtříku vedeném u MS v Praze, vložka
            67745, oddíl C.
          </p>
        </div>
      </div>
      <p className="contacts-components-subfooter">
